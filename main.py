...
def main():
    ...
    print(
        f"{'Operation':<15}"
        f"{'Python Dictionary':<25}"
        f"{'Custom BST':<25}"
    )

    print(
        f"{'Insert':<15}"
        f"{hash_insert_time:<25.8f}"
        f"{bst_insert_time:<25.8f}"
    )

    print(
        f"{'Search':<15}"
        f"{hash_search_time:<25.8f}"
        f"{bst_search_time:<25.8f}"
    )

    print(
        f"{'Delete':<15}"
        f"{hash_delete_time:<25.8f}"
        f"{bst_delete_time:<25.8f}"
    )
    ...
    print("Binary Search Tree stores data in sorted order.")
    print("Hash Table is preferred for fast lookup operations.")
    print("BST is useful when ordered data operations are required.")
